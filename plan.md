...
- 已建立可安裝的原生 Android app（package `com.victor.vvwiki`、app name `vv知識酷`、version `0.1.17`）。
...
- Main／Reader orientation change 使用 configChanges 保留既有頁面與 WebView；Library、Search、Comments 移除多餘 header，landscape 使用 compact command bar 與可滾動內容清單。

...
可離線瀏覽兩個 Wiki 的 Android MVP（v0.1.11）。Markdown Reader 以
...
- 長壓文字可使用系統 Process Text 選單（例如翻譯）、`🔊 TTS`；TTS notification 支援暫停／繼續、前後 10 秒、1.5× 與關閉，也可加入 comment／question；Comments tab 可查看、跳轉、修改、刪除註解並管理 remote comments branch
